...
export const projects = [
  {
    ...
    deployedSrc: "https://bennetthumphrey.github.io/Electrical-Site-1-React/",
  ...
  },
  {
    ...
    deployedSrc: "https://bennetthumphrey.github.io/Electrical-Site-2-React/",
    description: "My second finished electrical template, and the first one with multiple pages. I added two image sliders as well, to make it more engaging. There are some issues refreshing pages, but that is because of Github Pages not properly supporting single-page apps, and works perfectly fine on real, deployed sites",
  ...
  },
  {
    ...
    deployedSrc: "https://bennetthumphrey.github.io/Electrical-Site-3-React/",
    description: "My third electrical template, this time with some more animations and movement. There are again some issues refreshing pages, but that is because of Github Pages not properly supporting single-page apps, and works perfectly fine on real, deployed sites",
